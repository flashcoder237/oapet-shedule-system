    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
        />
              ...
              <CardContent className="p-0">
                {isLoading ? (
                  ...
                  <div className="px-4 py-8 text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Aucun résultat trouvé</p>
                  ...
                  <div className="divide-y divide-gray-100">
                    ...
                    <div className="p-4 bg-gray-50">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium text-gray-700">Conseils de recherche</span>
                      </div>
